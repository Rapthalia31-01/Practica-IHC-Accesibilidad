...
/** Esta funcion se llama cuando la persona hace click en la fecha izquierda del carusel para navegar a la izquierda */
function clickLeft() {
  const currentLeft = parseInt(
    getComputedStyle(document.querySelector(".project-container")).left,
    10
...
/** Esta funcion se llama cuando la persona hace clic en el boton de enviar del formulario de contacto */
...
/** Esta funcion se llama cuando la persona hace clic en cualquier porjecto del carusel */
...
function closeModal(e) {
  // si el clic occurio dentro del las imagenes del carusel o dentro del modal, no se cierra el modal
  if (
